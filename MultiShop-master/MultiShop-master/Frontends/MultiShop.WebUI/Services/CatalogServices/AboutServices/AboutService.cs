...
namespace MultiShop.WebUI.Services.CatalogServices.AboutServices
{
    public class AboutService : IAboutService
    {
        ...
        public async Task<UpdateAboutDto> GetByIdAboutAsync(string id)
        {
            ...
            return JsonConvert.DeserializeObject<UpdateAboutDto>(json);
        }
        public async Task<List<ResultAboutDto>> GetAllAboutAsync()
        {
            ...
            if (string.IsNullOrWhiteSpace(jsonData)) return new List<ResultAboutDto>();
            return JsonConvert.DeserializeObject<List<ResultAboutDto>>(jsonData) ?? new List<ResultAboutDto>();
        }
