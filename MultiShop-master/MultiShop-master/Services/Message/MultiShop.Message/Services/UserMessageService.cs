...
namespace MultiShop.Message.Services
{
    public class UserMessageService : IUserMessageService
    {
        ...
        public async Task CreateMessageAsync(CreateMessageDto createMessageDto)
        {
            ...
            value.MessageDate = value.MessageDate.Kind switch
            {
                DateTimeKind.Utc => value.MessageDate,
                DateTimeKind.Local => value.MessageDate.ToUniversalTime(),
                _ => DateTime.SpecifyKind(value.MessageDate, DateTimeKind.Utc)
            };
        ...
        public async Task UpdateMessageAsync(UpdateMessageDto updateMessageDto)
        {
            ...
            values.MessageDate = values.MessageDate.Kind switch
            {
                DateTimeKind.Utc => values.MessageDate,
                DateTimeKind.Local => values.MessageDate.ToUniversalTime(),
                _ => DateTime.SpecifyKind(values.MessageDate, DateTimeKind.Utc)
            };
